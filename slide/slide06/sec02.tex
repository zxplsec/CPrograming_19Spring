...
\begin{frame}[fragile]\ft{\secname：终止\lstinline|while|循环}
...
\lstinputlisting[language=c,frame=single,numbers=left]{slide06/code/when.c}    
  \end{minipage}~~~~
...
\begin{frame}[fragile]\ft{\secname：\lstinline|while|：入口条件循环}
...
\lstinputlisting[language=c,frame=single,numbers=left]{slide06/code/while1.c}    
  \end{minipage} ~~~~\pause 
  \begin{minipage}{0.3\textwidth}
\begin{lstlisting}[backgroundcolor=\color{red!10}]
n = 0
...
\begin{frame}[fragile]\ft{\secname：语法要点}
\lstinputlisting[language=c,frame=single,numbers=left]{slide06/code/while2.c}
\pause 
\begin{lstlisting}[backgroundcolor=\color{red!10}]
n = 4
