...
\begin{frame}[fragile]\ft{\secname}
\lstinputlisting[]{slide06/code/for_cube.c}
\end{frame}
...
\begin{frame}[fragile]\ft{\secname：利用 \lstinline|for| 的灵活性}
1、 可以使用自减运算符来减小计数器。
\lstinputlisting[]{slide06/code/for_down.c}
\end{frame}
...
\lstinputlisting[]{slide06/code/for_13s.c}
\end{frame}
...
\begin{frame}[fragile]\ft{\secname：利用 \lstinline|for| 的灵活性}
3、 可让字符代替数字进行计数。
\lstinputlisting[]{slide06/code/for_char.c}
\end{frame}
...
\begin{frame}[fragile]\ft{\secname：利用 \lstinline|for| 的灵活性}
4、 可判断迭代次数之外的条件。
\lstinputlisting[]{slide06/code/for_cube1.c}
\end{frame}
...
\lstinputlisting[]{slide06/code/for_geo.c}
\end{frame}
...
\lstinputlisting[]{slide06/code/for_wild.c}
\end{frame}
...
\begin{frame}[fragile]\ft{\secname：利用 \lstinline|for| 的灵活性}
  \lstinputlisting[]{slide06/code/for_none.c}
\end{frame}
...
\begin{frame}[fragile]\ft{\secname：利用 \lstinline|for| 的灵活性}
  \lstinputlisting[]{slide06/code/for_show.c}
\end{frame}
