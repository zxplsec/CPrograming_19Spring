...
\begin{frame}[fragile,allowframebreaks]\ft{\secname： \lstinline|printf()| 的 \lstinline|*| 修饰符}
  \lstinputlisting
  {slide04/code/varwidth.c}
% \end{frame}

% \begin{frame}[fragile]\ft{\secname：\lstinline|printf()| 的 \lstinline|*| 修饰符}
  \pause 
\begin{lstlisting}[showspaces=true,backgroundcolor=\color{red!20}]
What field width?
6
...
\begin{frame}[fragile]\ft{\secname： \lstinline|scanf()| 的 \lstinline|*| 修饰符}
