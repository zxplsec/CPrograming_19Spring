...
\begin{frame}\ft{地址总线}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=2.5in]{ch01/images/dizhizongxian}
    \caption{地址总线发送的地址信息}
  \end{figure}
...
\begin{frame}\ft{数据总线}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=2.5in]{ch01/images/shujuzongxian1}
...
\begin{frame}\ft{数据总线}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=2.in]{ch01/images/shujuzongxian2}
...
\begin{frame}\ft{通用寄存器}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=3.5in]{ch01/images/tongyongjicunqi1}
    \caption{16位寄存器的逻辑结构}
  \end{figure}
...
%   \begin{figure}
%     \centering
%     \includegraphics[width=4in]{ch01/images/xunzhi}
...
%   \begin{figure}
%     \centering
%     \includegraphics[width=4in]{ch01/images/xunzhi1}
...
%   \begin{figure}
%     \centering
%     \includegraphics[width=4in]{ch01/images/duan}
