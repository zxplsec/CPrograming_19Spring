...
\begin{frame}\ft{C的起源}
  \begin{figure}
    \centering
    \includegraphics[width=4in]{ch01/images/Ritche}
  \end{figure}
\end{frame}
...
\begin{frame}\ft{C的起源}
  \begin{figure}
    \centering
    \includegraphics[width=2in]{ch01/images/Thompson}
...
\begin{frame}\ft{C的起源}
  \begin{figure}
    \centering
    \includegraphics[width=3in]{ch01/images/Ritche_Thompson}
...
\begin{frame}\ft{关于Ritche}
  \begin{figure}
    \centering
    \includegraphics[width=3.5in]{ch01/images/Ritche1}
  \end{figure}
