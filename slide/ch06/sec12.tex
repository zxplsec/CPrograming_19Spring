...
\begin{frame}[fragile]\ft{pow函数的使用}

\lstinputlisting[language=c,numbers=left,frame=single]{Code/pow.c}
...
\lstinputlisting[language=c,numbers=left,frame=single]{Code/power.c}
\end{frame}
